...
// file: onesignal-free-web-push-notifications/onesignal-public.php
...
//    changed by nabtron to wp_footer
    add_action('wp_footer', array(__CLASS__, 'onesignal_header'), 10);
  }
  ...
  public static function onesignal_header() {
    ...
    if (defined('ONESIGNAL_DEBUG') && defined('ONESIGNAL_LOCAL')) {
        ...
        echo '<!--<script src="https://cdn.onesignal.com/sdks/OneSignalSDK.js" async></script>--><!-- changed by nabtron -->';
      }
    ?>
    <script>
		// added by nabtron start
		window.addEventListener("load", onesignallazyloadtimeout, false);
		
		function onesignallazyloadtimeout(){
			setTimeout(onesignallazyload(), 3000);
		}
		
		function onesignallazyload(){ // closes at the end - added by nabtron
			var tag = document.createElement("script");
			tag.src = "https://cdn.onesignal.com/sdks/OneSignalSDK.js";
			document.getElementsByTagName("head")[0].appendChild(tag);
			
		// added by nabtron ends, but starts down again
      ...
      OneSignal.push( function() {
		...
		} // onesignallazyload closes - nabtron
