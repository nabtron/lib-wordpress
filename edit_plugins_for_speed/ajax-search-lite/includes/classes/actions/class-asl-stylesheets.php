...
file:  ajax-search-lite/includes/classes/actions/class-asl-stylesheets.php
...
if (!class_exists("WD_ASL_StyleSheets_Action")) {
    ...
    class WD_ASL_StyleSheets_Action extends WD_ASL_Action_Abstract {
        ...
        public function handle() {
            ...
            // changed to footer by nabtron
            add_action('wp_footer', array($this, 'inlineCSS'), 10, 0);
			...
			*/
            ...
            @font-face {
                font-family: 'aslsicons2';
                src: url(https://cdn.holidayrider.com/wp-content/plugins/ajax-search-lite/css/fonts/icons2.eot);
                src: url(https://cdn.holidayrider.com/wp-content/plugins/ajax-search-lite/css/fonts/icons2.eot?#iefix) format('embedded-opentype'),
                     url(https://cdn.holidayrider.com/wp-content/plugins/ajax-search-lite/css/fonts/icons2.woff2) format('woff2'),
                     url(https://cdn.holidayrider.com/wp-content/plugins/ajax-search-lite/css/fonts/icons2.woff) format('woff'),
                     url(https://cdn.holidayrider.com/wp-content/plugins/ajax-search-lite/css/fonts/icons2.ttf) format('truetype'),
                     url(https://cdn.holidayrider.com/wp-content/plugins/ajax-search-lite/css/fonts/icons2.svg#icons) format('svg');
                font-weight: normal;
                font-style: normal;
				font-display: swap;
            }
