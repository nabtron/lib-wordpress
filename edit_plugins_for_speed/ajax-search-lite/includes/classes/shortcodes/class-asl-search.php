    ...
    class WD_ASL_Search_Shortcode extends WD_ASL_Shortcode_Abstract {
        ...
        public function fonts() {
            ...
            foreach ($imports as $import) {
                ...
                ?>
                <!--<link href='<?php echo $import; ?>' rel='stylesheet' type='text/css'>--><!-- edited by nabtron to next line -->

				<link rel="stylesheet" href="<?php echo $import; ?>" media="none" onload="if(media!='all')media='all'">
				<noscript><link rel="stylesheet" href="<?php echo $import; ?>"></noscript>
                <?php
            }
        }
